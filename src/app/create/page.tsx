...
export default function CreatePage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* 사이드 네비게이션 */}
      <aside className="w-64 border-r border-gray-100 bg-white flex flex-col justify-between py-10 px-6 shrink-0">
        <div>
          {/* 로고 */}
          <div className="mb-12">
            <span className="text-xl font-bold tracking-tight">brandkit</span>
          </div>
            ...
            {STEPS.map((step) => {
              ...
              return (
                ...
                >
                  ...
                  {step.optional && (
                    <span className="ml-auto text-xs text-gray-400">선택</span>
                  )}
                </button>
              )
            })}
      ...
      {/* 메인 콘텐츠 */}
      <main className="flex-1 flex flex-col items-center justify-center px-16 py-10 bg-gray-50">
