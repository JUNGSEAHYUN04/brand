...
export default function Home() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* 헤더 */}
      <header className="px-6 md:px-8 py-5 flex items-center justify-between border-b border-gray-100">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 md:px-8 text-center">
        <div className="w-full max-w-lg">
          ...
          {/* 타이틀 */}
          <h1 className="text-4xl md:text-5xl font-bold text-gray-950 leading-tight tracking-tight mb-6">
            키워드 하나로<br />완성되는 브랜드
          </h1>
      ...
      {/* 푸터 */}
      <footer className="px-6 md:px-8 py-5 border-t border-gray-100">
