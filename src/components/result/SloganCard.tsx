...
export default function SloganCard({ brand }: Props) {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-6 flex flex-col">
      {/* 헤더 */}
      <div className="mb-5">
        <p className="text-xs text-gray-400 uppercase tracking-widest">Slogan</p>
      </div>
      ...
      <div className="flex-1 space-y-4 mb-6">
        ...
        <button
          ...
          className="w-full text-left p-4 rounded-xl bg-gray-950 group transition-all hover:bg-gray-800"
        >
      ...
      <div className="pt-4 border-t border-gray-50">
        <p className="text-xs text-gray-400 mb-2">Brand Personality</p>
      ...
      <div className="pt-4 mt-4 border-t border-gray-50">
        <p className="text-xs text-gray-400 mb-2">Tone & Manner</p>
        <p className="text-xs text-gray-500 leading-relaxed">{brand.tone}</p>
      </div>
    </div>
  )
}