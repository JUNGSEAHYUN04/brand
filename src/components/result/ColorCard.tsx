...
export default function ColorCard({ colors }: Props) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6">
      {/* 헤더 */}
      <div className="mb-5">
        <p className="text-xs text-gray-500 uppercase tracking-widest mb-1">Color Palette</p>
      </div>
        ...
        {coreColors.map((color) => (
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className="text-xs font-medium text-gray-800">{color.label}</p>
      ...
      {/* 뉴트럴 팔레트 */}
      <div className="mb-5">
        <p className="text-xs text-gray-600 font-medium mb-2">Neutral</p>
          ...
          {neutralColors.map((color) => (
            ...
            >
              <div
                ...
                style={{ backgroundColor: color.hex }}
              />
              <p className="text-xs text-gray-500 text-center">{color.label}</p>
            </button>
          ))}
        </div>
      </div>
      ...
      {/* 시맨틱 컬러 */}
      <div>
        <p className="text-xs text-gray-600 font-medium mb-2">Semantic</p>
